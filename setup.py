    ...
    setup(
        ...
        entry_points={
            "console_scripts": [
                ...
                "qfit_bs = qfit.command_line.qfit_bs:main",
                ...
                "event_map_bdc_scaler = qfit.command_line.event_map_bdc_scaler:main",
                ...
                "compare_rscc = qfit.command_line.compare_sidechain_rscc:main",
