...
BASE_DIR="/home/ngupta/main/program_exp/qfit-3.0/test_case"
...
RSR_SCRIPTS_DIR="/home/ngupta/main/program_exp/qfit-3.0/rsr_scripts"
ANALYSIS_SCRIPTS_DIR="/home/ngupta/main/program_exp/qfit-3.0/analysis_scripts"
LIG_SCRIPTS_DIR="/home/ngupta/main/program_exp/qfit-3.0/lig_scripts"
...
set -- run_1 placer_1 filter_1 placer2_1 filter2_1 final_1 despot_1 -c --f2_filter_proportion 1 "$@"
...
if [ -n "$despot_run_name" ]; then
    despot_ok=1
    for dataset in "${DATASETS[@]}"; do
        despot_filtered_pdb="${DATASETS_DIR}/${dataset}/${run_name}/${placer_run_name}/${filter_run_name}/${placer2_run_name}/${filter2_run_name}/${final_run_name}/${despot_run_name}/despot_filtered.pdb"
        if [ ! -f "$despot_filtered_pdb" ]; then
            despot_ok=0
        fi
    done
    despot_graphs_dir="${GRAPHS_DIR}/${run_name}/${placer_run_name}/${filter_run_name}/${placer2_run_name}/${filter2_run_name}/${final_run_name}/${despot_run_name}"
